							...
							<div class="card-body">
								<div class="m-sm-4">
									<div class="text-center">
										<img src="{{asset("/dashboard/dist/img/avatars/avatar.jpg")}}" alt="Charles Hall" class="img-fluid rounded-circle" width="132" height="132" />
									</div>
                                    @include('admin.error')
									<form method="POST" action="{{ route('admin.login') }}">
										...
										<div class="mb-3">
											...
											<input class="form-control form-control-lg" value="Ecommerce-2024" type="password" name="password" placeholder="Enter your password" />
											<small>
